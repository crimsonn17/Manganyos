...
import com.application.manganyos.adapters.ImagesAdapter;
import com.application.manganyos.adapters.MenuListRecyclerAdapter;
import com.application.manganyos.fragments.PhotoViewFragment;
import com.application.manganyos.interfaces.RecyclerItemClickListener;
import com.application.manganyos.models.InternetTimeResponse;
import com.application.manganyos.models.Menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuOnItemClickListener = new MenuListRecyclerAdapter.OnItemClickListener() {
            ...
            public void onOrderChanged(Menu changedItem) {
                ...
                // Updating UI
                subTotalTextView.setText(("Rp. ").concat(String.valueOf(RestaurantUtils.round(subTotal, 2))));
                cgstTextView.setText(("Rp. ").concat(String.valueOf(RestaurantUtils.round(taxAmount, 2))));
                sgstTextView.setText(("Rp. ").concat(String.valueOf(RestaurantUtils.round(taxAmount, 2))));
                totalAmountTextView.setText(("Rp. ").concat(String.valueOf(RestaurantUtils.round(totalAmount, 2))));
